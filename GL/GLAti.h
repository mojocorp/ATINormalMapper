...
#define GL_MIN_ELEMENTS_ATI                 0x001a0000  // TEMPORARY VALUE
...
typedef GLvoid            (APIENTRY *PFNGLATTACHMEMATIPROC)(GLenum target,
                                                            GLenum attachment,
                                                            GLmem mem);
typedef GLvoid            (APIENTRY *PFNGLDETACHMEMATIPROC)(GLmem mem);
...
#define GL_DRM_ENABLED                            0x00400000  // TEMPORARY VALUE
#define GL_DRM_BUFFERS                            0x00400001  // TEMPORARY VALUE
#define GL_DRM_BUFFER_SIZE                        0x00400002  // TEMPORARY VALUE
#define GL_DRM_BUFFER_QUEUE                       0x00000001
#define GL_DRM_SUBMIT_QUEUE                       0x00000002

typedef GLvoid (APIENTRY *PFNGLGETDRMINFOIVATIPROC)(GLenum pname, GLint *param);
typedef GLuint (APIENTRY *PFNGLCHECKDRMSUBMITATIPROC)(GLuint drmflags);
typedef GLuint (APIENTRY *PFNGLLOCKDRMATIPROC)(GLvoid);
typedef GLvoid (APIENTRY *PFNGLUNLOCKDRMATIPROC)(GLvoid);
...
#define GL_CMM_TOTAL_BYTES_FB            0x00400100  // TEMPORARY VALUE
#define GL_CMM_TOTAL_BYTES_INVISIBLE_FB  0x00400101  // TEMPORARY VALUE
#define GL_CMM_TOTAL_BYTES_AGP           0x00400102  // TEMPORARY VALUE

typedef GLuint (APIENTRY *PFNGLGETCMMINFOATIPROC)(GLenum pname, GLvoid *param);
...
// wwlk
#ifndef __GL_SUPPORT_GL2_EXTENSIONS
#define __GL_SUPPORT_GL2_EXTENSIONS 1
/*
