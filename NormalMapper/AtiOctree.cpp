...
///////////////////////////////////////////////////////////////////////////////
void
AtiOctree::GetBoundingBox(int32 childIndex, AtiOctBoundingBox* bbox, AtiOctreeCell* child)
{
    // Figure out min/maxs
    switch (childIndex) {
...
///////////////////////////////////////////////////////////////////////////////
bool8
AtiOctree::FillTree(int32 numItems,
                    void* itemList,
    ...
    while (numCells > 0) {
        ...
        for (int32 c = 0; c < 8; c++) {
            ...
            for (int32 i = 0; i < currCell->m_numItems; i++) {
                if (fnItemInBox(currCell->m_item[i], itemList, &child->m_boundingBox) == TRUE) {
