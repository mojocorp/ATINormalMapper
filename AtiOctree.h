...
typedef bool8 (*AtiPfnItemInBox)(int32 itemIndex, void* itemList, AtiOctBoundingBox* m_boundingBox);
...
class AtiOctree
{
  public:
    ...
    // Fill the tree
    bool8 FillTree(int32 numItems,
                   void* itemList,
                   AtiOctBoundingBox& boundingBox,
                   AtiPfnItemInBox fnItemInBox,
                   int32 maxInBox,
  ...
  private:
    ...
    void GetBoundingBox(int32 childIndex, AtiOctBoundingBox* bbox, AtiOctreeCell* child);
};
